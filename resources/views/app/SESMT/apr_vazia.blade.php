...
<head>
    <meta charset="UTF-8">
    <title>APR - MODELO EM BRANCO</title>
...
<body>
    ...
    <div class="header">
        <h2>ANÁLISE PRELIMINAR DE RISCOS (APR) - MODELO</h2>
  
        <div style="border: solid 1px; padding:5px; margin-bottom:10px;">
        ...
        <div style="display: block; width: 100%; border: 1px solid #000; margin-bottom: 10px; clear: both;">
            ...
            <div style="width: 60%; float: left; border-right: 1px solid #000; padding: 5px; min-height: 120px;">
                <div style="margin-bottom: 10px; border-bottom: 1px solid #eee;">
                    ...
                    <strong>Descrição:</strong> {{ $risco->descricao }} <br><br>

                    <strong>Prob:</strong> ____ |
                    <strong>Sev:</strong> ____ |
                    <strong>Grau:</strong> ____
                </div>
