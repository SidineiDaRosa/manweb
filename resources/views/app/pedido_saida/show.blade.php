...
<main class="content">
    <div class="card-header-template">
        <div>
            ...
            <a class="btn btn-outline-primary mb-1" href="{{route('pedido-saida.index')}}">
        ...
        <tbody>
            ...
            <tr>
                <td hidden>
                    ...
                    {{ $saida_produto->pedidos_saida_id }}
                </td>
                <td>
                    <a class="txt-link" href="{{ route('produto.show', ['produto' =>$saida_produto->produto_id]) }}">
                        {{ $saida_produto->produto_id }}
                    </a>
                </td>
                <td>
                    @php
                ...
                <td hidden>{{ $saida_produto->equipamento_id }}</td>
                <td><!--//---------------------------//--->
                    <!-- Botão de exclusão -->
