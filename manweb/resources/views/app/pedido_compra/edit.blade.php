...
<form action="{{route('pedido-compra.store')}}" method="POST">
    ...
    <div class="row mb-1">
        ...
        <div class="col-sm-4">
            <input id="hora_prevista" name="funcionarios_id" type="text" class="form-control" value="1">
        </div>
    </div>
    <div class="row mb-1">
        <label for="cnpj" class="col-md-4 col-form-label text-md-end text-right">Situação</label>
        <div class="col-sm-2">
            <input id="hora_prevista" name="status" type="text" class="form-control" value="aberto">
        </div>
    </div>
    <div class="row mb-1">
        <label for="cnpj" class="col-md-4 col-form-label text-md-end text-right">Descrição</label>
        <div class="col-sm-4">
            <input id="descricao" name="descricao" type="text" class="form-control" value="1">
        </div>
    </div>
    <div class="row mb-0">
